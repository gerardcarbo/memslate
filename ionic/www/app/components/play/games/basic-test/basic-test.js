(function () {
 ...
 .component('msBasicTest', {
    templateUrl: 'app/components/play/games/basic-test/basic-test-template.html',
    controllerAs: 'basicTestCtrl',
    controller: function ($scope, $timeout, $location, $ionicScrollDelegate, $ionicModal, GamesService,
                          LanguagesService, SessionService, UserStatusService, UI) {
      var self = this;
      ...
      self.init = function ()
      {
        ...
        self.gameLangs = [];
        self.useAnonymousLangs = false;
        self.useAnonymousLangsDisabled=false;
        self.levels=[{name:'Easy',value:'0-.3'},{name:'Medium',value:'.3-.55'},{name:'High',value:'.55-1'},{name:'Any',value:'0-1'}];
        self.getLanguages();
      };
      ...
      this.evaluateTest = function () {
        ...
        $ionicModal.fromTemplateUrl('app/components/play/games/basic-test/basic-test-modal.html', {
          scope: $scope,
