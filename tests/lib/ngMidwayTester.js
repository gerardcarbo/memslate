/**
 * Created by gerard on 27/04/2015.
 */
/**
 ...
 * @param {Object} [options.window=window] The window node of the page
 * @param {Object} [options.document=document] The document node of the page
 * @param {Object} [options.templateUrl] The template file for the HTML layout of the tester
 * @param {Object} [options.template] The template string for the HTML layout of the tester
 * @param {Object} [options.mockLocationPaths=true] Whether or not to fake the URL change in the browser address bar
...
;var ngMidwayTester = function(moduleName, options) {
    ...
    var moduleDep = options.dependency;
    ...
    if(moduleDep)
    {
        var $injector = angular.bootstrap($rootElement, ['ng','ngMidway',moduleName,moduleDep]);
    }
    else
    {
    ...
    return {
        ...
        /**
         * Attaches the $rootElement module to the provided controller
         * @method controller
